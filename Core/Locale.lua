...
local L = {
	...
	ROUTE_UNREACHABLE = "No teleport of yours goes there: get to that continent, then the arrow takes over.",
	ROUTE_ARRIVED = "You are there.",
	ROUTE_STOP = "Stop",
	ROUTE_STEP_FAR = "Get to %s",
	ROUTE_ZONE_WIDE = "somewhere in this zone",
	ARROW_YARDS = "%.0f yd",
	ARROW_PROGRESS = "step %d of %d",
	ARROW_USE = "Use %s",
	ARROW_PORTAL = "Portal: %s",
	ARROW_OTHER_CONTINENT = "Another continent: %s",
	ARROW_ELSEWHERE = "Head for %s",
	ARROW_ZONE_WIDE = "zone-wide target — look around once there",
	ARROW_ARRIVED = "you are there",
...
if GetLocale and GetLocale() == "frFR" then
	...
	L.ROUTE_UNREACHABLE = "Aucun de tes téléports n'y va : rejoins ce continent, la flèche prend le relais."
	L.ROUTE_ARRIVED = "Tu y es."
	L.ROUTE_STOP = "Arrêter"
	L.ROUTE_STEP_FAR = "Rejoins %s"
	L.ROUTE_ZONE_WIDE = "quelque part dans cette zone"
	L.ARROW_YARDS = "%.0f m"
	L.ARROW_PROGRESS = "étape %d sur %d"
	L.ARROW_USE = "Utilise %s"
	L.ARROW_PORTAL = "Portail : %s"
	L.ARROW_OTHER_CONTINENT = "Autre continent : %s"
	L.ARROW_ELSEWHERE = "Rejoins %s"
	L.ARROW_ZONE_WIDE = "cible à l'échelle de la zone — cherche sur place"
	L.ARROW_ARRIVED = "tu y es"
